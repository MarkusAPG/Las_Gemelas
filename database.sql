DROP DATABASE IF EXISTS tienda_disfraces;
CREATE DATABASE tienda_disfraces;
USE tienda_disfraces;

CREATE USER IF NOT EXISTS 'admin_disfraces'@'localhost' IDENTIFIED BY '12345';
GRANT ALL PRIVILEGES ON tienda_disfraces.* TO 'admin_disfraces'@'localhost';
FLUSH PRIVILEGES;
...
CREATE TABLE IF NOT EXISTS usuarios (
    ...
    correo_recuperacion VARCHAR(150) NULL,    -- NUEVO CAMPO
...
CREATE TABLE IF NOT EXISTS compras (
    ...
    id_usuario INT,
    id_producto INT,
    id_tecnico INT NULL,   -- técnico que registró la compra
